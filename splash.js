...
function restart_game(splash){
    ...
    restart.textContent = 'TRY AGAIN';  // sets the text of the button 
    restart.classList.add('start');     // reusing the start class for styling         
    restart.classList.add('restart');   // with restart button specific modifications
  
    splash.appendChild(restart);
  
    restart.addEventListener('click', function () {
      document.body.removeChild(darken_bg);   // removes darken_bg from the screen, a parent of splash, automatically removes splash as its a child of darken_bg
